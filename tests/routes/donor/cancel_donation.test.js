...
describe('Route: /api/donor/cancel-donation', () => {
    test('invalid donor', async () => {
        ...
        .expect(400)
        .then((response) => {
            expect(response.body.errorCode).toBe(donationCancellationEnums.DONOR_NOT_FOUND)
        })
    })

    test('valid donor and valid cancellation of donation', async () => {
        var donorInfo = {
            name: 'Donor',
            age: '22',
            bloodGroup: 'A',
